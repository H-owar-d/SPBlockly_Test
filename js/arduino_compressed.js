...
Blockly.Arduino.init=function(a){
	...
	this.setupsBottom_=Object.create(null);
	this.loops_=Object.create(null);
	this.loopsTop_=Object.create(null);	
	this.loopsBottom_=Object.create(null);
...
Blockly.Arduino.finish=function(a){
	...
	h=Blockly.utils.object.values(this.setupsBottom_);
	i=Blockly.utils.object.values(this.loopsTop_);	
	j=Blockly.utils.object.values(this.loops_);
	k=Blockly.utils.object.values(this.loopsBottom_);
	l=Blockly.utils.object.values(this.functions_);
	
	a=a.replace(" %1 ",f.join("\n")?f.join("\n").replace(/\n/g,"\n  ")+"\n  ":"");
	a=a.replace(" %2 ",g.join("\n")?g.join("\n").replace(/\n/g,"\n  ")+("\n  "):"");
	a=a.replace(" %3 ",h.join("\n")?h.join("\n").replace(/\n/g,"\n  ")+"\n  ":"");
	a=a.replace(" %4 ",i.join("\n")?i.join("\n").replace(/\n/g,"\n  ")+("\n  "):"");
	a=a.replace(" %5 ",j.join("\n")?j.join("\n").replace(/\n/g,"\n  ")+"\n  ":"");
	a=a.replace(" %6 ",k.join("\n")?k.join("\n").replace(/\n/g,"\n  ")+("\n  "):"");	
	a=a.replace(/  \n}/g,"}");
